...
#define LCD_LED(d)		GPIO_WriteBit(GPIOB, GPIO_Pin_8, d)		//PB8  LCD_LED_TEST
#define LCD_D1(d)		GPIO_WriteBit(GPIOB, GPIO_Pin_14, d)		//PB14 OLED_D1
#define LCD_D0(d)		GPIO_WriteBit(GPIOB, GPIO_Pin_13, d)		//PB13 OLED_D0
#define LCD_DC(d)		GPIO_WriteBit(GPIOB, GPIO_Pin_12, d)		//PB12 OLED_DC
#define LCD_RES(d)		GPIO_WriteBit(GPIOB, GPIO_Pin_11, d)		//PB11 OLED_RES
#define LCD_CS(d)		GPIO_WriteBit(GPIOB, GPIO_Pin_10, d)		//PB10		OLED_CS
